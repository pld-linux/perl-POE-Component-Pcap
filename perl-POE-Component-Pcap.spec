...
POE::Component::Pcap dostarcza wrapper do używania modułu Net::Pcap z
poziomu programów POE. Komponent ten tworzy oddzielną sesję wysyłającą
zdarzenia do określonej sesji i stanu, kiedy pakiety są dostępne.
